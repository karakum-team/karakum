...
fun createPlugins(
    ...
    nameResolvers: List<NameResolver>,
    inheritanceModifiers: List<InheritanceModifier>,
    mutabilityModifiers: List<MutabilityModifier>,
    varianceModifiers: List<VarianceModifier>,
    program: Program,
