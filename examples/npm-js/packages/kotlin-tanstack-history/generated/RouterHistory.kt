...
var length: Double
var subscribers: js.collections.ReadonlySet<(opts: SubscriberArgs) -> Unit>
var subscribe: (cb: (opts: SubscriberArgs) -> Unit) -> () -> Unit
var push: (path: String, state: Any? /* use undefined for default */, navigateOpts: NavigateOptions? /* use undefined for default */) -> Unit
var replace: (path: String, state: Any? /* use undefined for default */, navigateOpts: NavigateOptions? /* use undefined for default */) -> Unit
