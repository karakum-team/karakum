...
fun push(path: String, state: Any? = definedExternally, navigateOpts: NavigateOptions = definedExternally): Unit
fun replace(path: String, state: Any? = definedExternally, navigateOpts: NavigateOptions = definedExternally): Unit
fun go(index: Int, navigateOpts: NavigateOptions = definedExternally): Unit
